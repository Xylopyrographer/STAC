 ...
 *      - for the V160HD, SDI channel display colours are inverted from HDMI 1 to 8
*/
    ...
    if ( tallyStatus.tChannel < 9 ) {
        ...
        drawGlyph( glyphMap[tallyStatus.tChannel - 8], tallychangecolorSDI, 1 );    // display the current tally channel
    }
    ...
    do {
        ...
        if ( dButt.wasReleased() ) {
            ...
            if ( tallyStatus.tChannel < 9 ) {
            drawGlyph( glyphMap[tallyStatus.tChannel], tallychangecolor, 1 );    // display the current V160 HDMI tally channel
            }
            else {
            drawGlyph( glyphMap[tallyStatus.tChannel - 8], tallychangecolorSDI, 1 );    // display the current V160 SDI tally channel
            }
        }
