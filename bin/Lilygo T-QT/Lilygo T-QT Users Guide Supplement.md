# LilyGo T-QT Users Guide Supplement

This document outlines the differences in the STAC software for the LilyGo T-QT.
...
The T-QT supports Peripheral Mode operation by monitoring the state of GPIO43 and GPIO42 on the bottom connector as per the table below.

<table>
	<tbody><center>
		<tr>
			<td rowspan="2"><center><b>GPIO 42<br>(TS_1)</b></</center></td>
			<td rowspan="2"><center><b>GPIO 43<br>(TS_0)</b></center></td>
...
When operating in **normal state** (not Peripheral Mode), the T-QT outputs its current tally state to the connector on the bottom of the device on pins GPIO43 and GPIO42 as per the table below.

| GPIO 42<br>(TS_1) | GPIO 43<br>(TS_0) | ROLAND SWITCH<br>TALLY STATE |
|:---:|:---:|:---:|
| 0 | 0 | UNKNOWN |
| 0 | 1 | UNSELECTED |
| 1 | 0 | PVW |
