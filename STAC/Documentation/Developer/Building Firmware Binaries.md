...
All binaries are automatically copied to:
```
/path/to/STAC/bin/
```
...
| Environment | Board | Display | Build Type | Log Level |
|------------|-------|---------|------------|-----------|
| `atom-matrix` | M5Stack ATOM | 5x5 | Debug | DEBUG (D3) |
| `atom-matrix-release` | M5Stack ATOM | 5x5 | Release | ERROR |
| `waveshare-s3` | Waveshare S3 | 8x8 | Debug | DEBUG (D3) |
| `waveshare-s3-release` | Waveshare S3 | 8x8 | Release | ERROR |
