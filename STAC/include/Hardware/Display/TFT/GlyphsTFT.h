...
namespace Display {
    ...
    namespace Rotation {
        ...
        constexpr uint8_t LUT_UP[GLYPH_SIZE] = {0};
        constexpr uint8_t LUT_DOWN[GLYPH_SIZE] = {0};
        constexpr uint8_t LUT_LEFT[GLYPH_SIZE] = {0};
        constexpr uint8_t LUT_RIGHT[GLYPH_SIZE] = {0};
    }
