...
namespace Display {
    ...
    class IDisplay {
      public:
         ...
         */
        virtual uint8_t getRotation() const {
            return 0;
        }
         ...
         * @note Default implementation does nothing (for displays that don't support rotation)
         */
        virtual void setOrientationRotation( Orientation orientation ) {
            ( void )orientation;
        }
         ...
         * @param rotation Initial rotation value
         * @note Default implementation does nothing (for displays that don't need pre-init rotation)
         */
        virtual void setInitialRotation( uint8_t rotation ) {
            ( void )rotation;
        }
    };
