/**
 * @file WaveshareS3_Config.h
 * @brief Board configuration for Waveshare ESP32-S3-Matrix
 * @version 1.1
 * @date 2026-01-23
 *
 * Revision History:
...
#define BOARD_BRIGHTNESS_MAP { 0, 3, 5, 7, 10, 13, 16, 20, 25 }
...
#define DEVICE_ORIENTATION_TO_LUT_MAP { \
        Orientation::ROTATE_180,  /* enum 0 → LUT_180 */ \
                    ...
                    Orientation::ROTATE_180,  /* FLAT → baseline at USB port */ \
...
#define HAS_PERIPHERAL_MODE_CAPABILITY true
    ...
    // Connector output pins for peripheral tally state
    #define PIN_TALLY_STATUS_0 5  // LSB of tally state (exposed on connector)
    #define PIN_TALLY_STATUS_1 6  // MSB of tally state (exposed on connector)
