...
#include "../build_info.h"  // Auto-generated build information
...
namespace Config {
    ...
    // Tally status output pins for peripheral connector
    ...
    namespace Timing {
        ...
        constexpr unsigned long BUTTON_ATEM_CONFIRM_MS = TIMING_BUTTON_SELECT_MS + 2500; ///< 4s hold to confirm+exit ATEM bank select
    ...
    namespace Strings {
        ...
        constexpr const char *SOFTWARE_VERSION = BUILD_VERSION;  // From auto-generated build_info.h
    }
