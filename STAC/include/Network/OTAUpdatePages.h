/**
 * @file OTAUpdatePages.h
 * @brief HTML page definitions for OTA firmware updates
 * 
 * This file contains the HTML/CSS/JavaScript pages used during OTA update mode.
 * Pages are embedded as raw string literals for serving via WebServer.
 * 
 * Ported from STACotaPages.h in baseline STAC implementation.
 * 
...
namespace OTAPages {
    ...
    /**
     * @brief Main OTA update page with file upload form
     * 
     * Allows user to select a .bin firmware file and upload it.
...
<body class="c4">
  ...
  <div>
    ...
    /**
     * @brief Opening HTML for update result pages
     */
    const char PAGE_OPEN[] = R"=====(<!DOCTYPE html>
<html>
<head>
...
<body>
  <h1 class="c2"><span class="c1">STAC Updater</span></h1>
    ...
    /**
     * @brief Success message fragment for update result page
     */
    const char SUCCESS[] = R"=====(<p class="c5"><span class="c4"><strong><span class="c3">Update Success</span></strong></span></p>
<p class="c5"><span class="c1">New firmware file:<br>)=====";

    /**
     * @brief Failure message fragment for update result page
     */
    const char FAILURE[] = R"=====(<p class="c5"><span class="c4"><strong><span class="c6">Update Failed</span></strong></span></p>
<p class="c5"><span class="c1">Reason:<br>)=====";

    /**
     * @brief Closing HTML for update result pages
     */
    const char PAGE_CLOSE[] = R"=====(<br>
<br>
...
to your regular WiFi network.</span></p>
    ...
    /**
     * @brief 404 Not Found page for OTA update server
     */
