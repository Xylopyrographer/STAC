...
*/
    ...
    theClient.print("<p align=\"center\"><font face=\"Helvetica, Arial, sans-serif\">Unit ID: ");
    theClient.println( stacID );
    theClient.print( "<br>Version: ");
    theClient.print( swVer );
    theClient.print( "<br>Core: ");
    theClient.print( ardesp32Ver );
    theClient.print( "<br>SDK: ");
    theClient.print( espidfsdk );
    theClient.print( "<br>MAC: ");
    theClient.print( WiFi.macAddress() );
