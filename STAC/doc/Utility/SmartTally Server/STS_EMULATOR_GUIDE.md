...
|-------|------------------|----------------|-----------|-----------|
| UNSELECTED | Purple/Black | Green | LOW | HIGH |
| SELECTED | Green | Green | HIGH | LOW |
| ONAIR | Red | Red | HIGH | HIGH |
| ERROR (No Reply) | Purple X | Green | LOW | LOW |
| ERROR (Junk) | Purple ? | Green | LOW | LOW |
| ERROR (Timeout) | Orange X | Green | LOW | LOW |
| ERROR (Other) | Red X | Green | LOW | LOW |
