...
## Comparison to v2.x Manual Process

### Baseline v2.x (Manual - 7 steps!)

```bash
1. Edit STAC.ino - remove old build number
2. Save and close all files
3. Run: hashdir -a md5 ~/Documents/STAC
4. Copy last 6 chars from output
5. Edit STAC.ino - paste build number
6. Save file
7. Upload
```

❌ Manual, error-prone, requires external tool

### V3.0 (Automatic - 1 step!)

```bash
pio run -t upload
```

✅ **That's it!** Build number auto-generated every build
...
✅ **Zero manual steps**  
✅ **Always accurate** (regenerated every build)  
✅ **No external tools** (built into PlatformIO)  
✅ **Git integrated** (commit + branch info)  
✅ **Cannot forget** (runs automatically)  
✅ **Cannot make mistakes** (fully automated)  
✅ **Build timestamp included**  
✅ **Better than baseline** (eliminates all manual work)
...
- ❌ Source code differs
- ⚠️ May behave differently

---

**Last Updated:** November 21, 2025  
**Replaces:** Manual hashdir process from v2.x
